...
public class SeeCourse extends javax.swing.JFrame {
  ...
  private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
    ...
    if(curcod != 0) {
      ArrayList students = Course.getStudentsByCourseAndYear(curcod, Integer.parseInt(promoBox.getSelectedItem().toString()));
      try {
        changeTable(students);
      } catch (ParseException ex) {
        Logger.getLogger(SeeCourse.class.getName()).log(Level.SEVERE, null, ex);
      }
    } else {
  ...
  private boolean checkEmptyFields() {
    if(promoBox.getSelectedIndex() == 0) {
  ...
  private void changeTable(ArrayList students) throws ParseException {

    Object[] columnNames = {"Nombre", "Apellido", "Usuario", "Sexo", "Correo Principal", "Telefono"};
    ...
    for (int i = 0; i < studentsSize; i++) {
      ...
      if(userType.equals("Alumno")) {
        if(currentStudent.getUsername().equals(menu.currentUsername)) isStudent = true;
      }
      
      model.addRow(new Object[]{currentStudent.getName(), currentStudent.getLastname(), currentStudent.getUsername(), currentStudent.getGender(), currentStudent.getEmail(), currentStudent.getPhone()});
    }  
    
    if(userType.equals("Alumno") && isStudent == false) {
      model.setRowCount(0);
      JOptionPane.showMessageDialog(null, "Usted no fue alumno en el curso y el año ingresado");
    } 
  }
}
