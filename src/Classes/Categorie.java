...
public class Categorie {
  ...
  public static String getCatName(int catcod) {
    BasicDataSource bs = Config.setDBParams();
      Connection connection = null;
      java.sql.Date todayDate = new java.sql.Date(new Date().getTime());

      String query = "SELECT * FROM `CATEGORIAS` WHERE `CAT_COD`='" + catcod + "' AND 'CAT_FECHAFIN' > ?;";
      ...
      try {
        ...
        if(rs.next()){
          return (String) rs.getString("CAT_NOMBRE");
        }
